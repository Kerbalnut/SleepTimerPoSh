...
$ProfileContent = Get-Content -Path $PoshProfile

Write-Host "--- $PoshProfile Content: ---`n$ProfileContent`n--- --- ---" -ForegroundColor Yellow -BackgroundColor Black

Invoke-Item $PoshProfile
